...
tests = [ {'description': '0x00 : start',
    'steps': [ {'inputs': [('PINA', 0x00)], 'iterations': 5 } ],
    'expected': [('PORTB', 0x07)],
    },
    {'description': '0x01 : inc',
    ...
    {'description': '0x03 : reset',
    'steps': [ {'inputs': [('PINA', 0x03)], 'iterations': 5 } ],
    'expected': [('PORTB', 0x00)],
    },
    {'description': '0x01 : hold inc',
    'steps': [ {'inputs': [('PINA', 0x01)], 'iterations': 10 } ],
    'expected': [('PORTB', 0x09)],
    },
    {'description': '0x02 : hold dec',
    'steps': [ {'inputs': [('PINA', 0x02)], 'iterations': 10 } ],
    'expected': [('PORTB', 0x00)],
    },
#    {'description': '0x0E : case 14',
